...
void SYS_Initialize ( void* data )
{
    ...
    OC1CON = 0x0000;
    ANSELBCLR = 0x01 << 3;
    OC1RS = 3 * TMR2_PERIOD / 4;
    OC1R = 3 * TMR2_PERIOD / 4;
    OC1CON = 0x0006;  // PWM, use Timer 2
    RPB3Rbits.RPB3R = 0x05; // Use B3 for OC1
    ...
    OC2CON = 0x0000;
    ANSELBCLR = 0x01 << 5;
    OC2RS = 3 * TMR3_PERIOD / 4;
    OC2R = 3 * TMR3_PERIOD / 4;
    OC2CON = 0x000E;  // PWM, use Timer 3
    RPB5Rbits.RPB5R = 0x05; // Use B5 for OC2
